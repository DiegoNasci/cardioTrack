    ...
    .row.justify-between.bd-bottom
      ...
      div
        .col-8.col-sm-6.q-mr-md
          .q-subheading Atalho 
            q-toggle(v-model="user.check" color="blue-7")
    .flex.flex-center
      div.q-ml-xl.inp-col
        h5.q-mb-md Informe os dados para cadastro
        .row
          .col-10.col-md-2.q-mb-sm.q-mr-lg
            q-input(v-model="user.code" stack-label="Código" type="number" disable="true")
          .col-10.col-md-3.q-mb-sm.q-mr-lg
            q-input(v-model="user.matriculation" stack-label="Matrícula" type="number" disable="true")
          .col-10.col-md-2.q-mb-sm.q-mr-lg
            q-select(stack-label="Cargo" v-model="user.adjutancy" :options="selectOptions")
          .col-10.col-md-3.q-mb-sm.q-mr-lg
            q-input(v-model="user.creation" stack-label="Criação" disable="true")
...
export default {
  data () {
    return{
      user: {
        code: '1',
        matriculation: '201410332',
        adjutancy: 'medic',
        creation: '04/10/2018 - 10:25',
        username: 'Diego',
