    ...
    .row.justify-between.bd-bottom
      div
        .col-8.col-sm-6.q-ml-md.q-mb-sm
          .q-subheading Paciente>Adicionar
      div
      ...
      div.q-ml-xl.cad-pat
        ...
        .row 
          .col-10.col-md-2.q-mb-sm.q-mr-lg
            q-input(v-model="patient.code" stack-label="Código" type="number")
          .col-10.col-md-3.q-mb-sm.q-mr-lg
            q-input(v-model="patient.cpf" stack-label="CPF" type="number")
          .col-10.col-md-3.q-mb-sm.q-mr-lg
            q-input(v-model="patient.rg" stack-label="RG" type="number")
          .col-10.col-md-2.q-mb-sm.q-mr-lg
